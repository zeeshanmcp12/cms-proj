...
<div class="list-group">
    ...
    <?php
        ...
        while($row = mysqli_fetch_array($send_query)){      //categories ko database se dynamically fetch karne k liye while ka loop lagaya hai
            ...
            echo "<a href='' class='list-group-item'>{$row['cat_title']}</a>"; //square bracket main agar cat_title nahi likhenge tu categories table k cat_title se data fetch nahi hoga.
        }
